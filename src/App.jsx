...
function App() {
  return (
    <>
      ...
      {/*Scroll*/}
      <div className=" text-white font-source-sans flex items-center z-20 justify-center fixed bottom-10 right-20 group hover:cursor-pointer hover:scale-110 duration-200">
