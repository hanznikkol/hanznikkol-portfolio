...
function App() {
  ...
  return (
    <>
      ...
      {/*Scroll*/}
      <div className="hidden text-white font-source-sans lg:flex items-center z-20 justify-center fixed bottom-10 right-10 lg:right-20 group hover:cursor-pointer hover:scale-110 duration-200">
